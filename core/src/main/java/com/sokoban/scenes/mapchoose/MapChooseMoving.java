...
public class MapChooseMoving extends MapChooseScene {
    public MapChooseMoving(Main gameMain, SokobanLevels levelEnum) {
    ...
    public void setupLevel(MapData levelChoosingMap) {
        ...
        addRacingButton(11f, 6f);
        addReturnButton(7f, 6f);
